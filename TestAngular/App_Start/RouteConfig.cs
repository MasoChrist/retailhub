...
namespace TestAngular
{
    public class RouteConfig
    {
        ...
        private static IEnumerable<Route> GetAllRoutes()
        {
            ...
            .Where(t => t.IsSubclassOf(typeof(Controller)) && t.IsPublic && !t.IsAbstract && t.Name.EndsWith("ViewController"));
            foreach (var type in types)
            {
                //Get the Controller Name minus the word Controller
                string controllerName = type.Name
                .Substring(0, type.Name.IndexOf("ViewController", System.StringComparison.InvariantCulture));
                ...
                foreach (var method in methods)
                {
                    ...
                    routeDictionary.Add("controller", controllerName +"View");
